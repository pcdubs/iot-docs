...
Images are available for download at the Fedora IoT https://getfedora.org/en/iot/[landing page]. There are three options available to install IoT on your device:
